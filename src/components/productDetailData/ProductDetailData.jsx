  ...
  return (
    <>
        ...
        <div className="aproductDetailArea my-10 flex justify-center items-center flex-wrap gap-5">
          <div className="productImageArea lg:flex items-center border">
            ...
            <div className="productPicView2 shadow-lg lg:w-96 lg:h-96 ">
              <img src={viewPic?viewPic:singleProductPic[0]} alt="productPic2" className='' />
            </div>
          </div>
      ...
      <div className='relatedProductSections pt-10 lg:mx-24'>
        ...
        {console.log(allProduct.filter((item) => { return (item.category === singleProduct.category)}).slice(0, 10))}
          <ProductsCard products={allProduct.filter((item) => { return (item.category === singleProduct.category)}).slice(0, 10)} addCart={addCart}/>
        </div>
      </div>
    </>
